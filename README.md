...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,492 | 🐛 160 | 🌐 Python | 📅 2026-09-18 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,418 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-17 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,319 | 🐛 40 | 🌐 Java | 📅 2026-09-17 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,319 | 🐛 40 | 🌐 Java | 📅 2026-09-17 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,140 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-18 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
* [Auto Archiver](https://github.com/bellingcat/auto-archiver) ⭐ 1,118 | 🐛 12 | 🌐 Python | 📅 2026-09-10 - Python script to automatically archive social media posts, videos, and images from a Google Sheets document. Read the [article about Auto Archiver on bellingcat.com](https://www.bellingcat.com/resources/2022/09/22/preserve-vital-online-content-with-bellingcats-auto-archiver-tool/).
...
* [Waybackpy](https://github.com/akamhy/waybackpy) ⭐ 605 | 🐛 23 | 🌐 Python | 📅 2024-02-26 -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool  *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 52 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-12 - A npm package and CLI tool for saving webpages as single HTML files. It does not produce WARC or WACZ archives. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,700 | 🐛 184 | 🌐 JavaScript | 📅 2026-09-11 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [SolrWayback](https://github.com/netarchivesuite/solrwayback) ⭐ 147 | 🐛 62 | 🌐 Java | 📅 2026-09-18 - A backend Java and frontend VUE JS project with freetext search and a build in playback engine. Require Warc files has been index with the Warc-Indexer. The web application also has a wide range of data visualization tools and data export tools that can be used on the whole webarchive. [SolrWayback 4 Bundle release](https://github.com/netarchivesuite/solrwayback/releases) ⭐ 147 | 🐛 62 | 🌐 Java | 📅 2026-09-18 contains all the software and dependencies in an out-of-the box solution that is easy to install.
...
* [bagnabit2warc](https://github.com/internetarchive/bagnabit2warc) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-03-09 - Convert a [bag-nabit](https://github.com/harvard-lil/bag-nabit) ⭐ 40 | 🐛 2 | 🌐 Python | 📅 2026-09-17 dataset stored in a ZIP into a full-content WARC.
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,907 | 🐛 107 | 🌐 Python | 📅 2026-09-15 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
...
* [jwarc](https://github.com/iipc/jwarc) ⭐ 64 | 🐛 19 | 🌐 Java | 📅 2026-09-01 - Read and write WARC files with a type safe API (Java).
...
* [Archives Unleashed Toolkit](https://github.com/archivesunleashed/aut) ⭐ 157 | 🐛 5 | 🌐 Scala | 📅 2026-09-17 - An open-source platform for analyzing web archives with Apache Spark. *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,881 | 🐛 724 | 🌐 C++ | 📅 2026-09-17 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,846 | 🐛 325 | 🌐 C | 📅 2026-06-30 - Click automation on Ubuntu.
...
* [Zotero Robust Links Extension](https://github.com/lanl/Zotero-Robust-Links-Extension) ⭐ 22 | 🐛 3 | 🌐 JavaScript | 📅 2022-05-10 - A [Zotero](https://www.zotero.org/) extension that submits to and reads from web archives. Supercedes [leonkt/zotero-memento](https://github.com/leonkt/zotero-memento) ⭐ 357 | 🐛 12 | 🌐 JavaScript | 📅 2022-06-08.

## Community Resources

### Other Awesome Lists

* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,492 | 🐛 160 | 🌐 Python | 📅 2026-09-18
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 475 | 🐛 327 | 🌐 TypeScript | 📅 2026-09-17.
