...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,229 | 🐛 159 | 🌐 Python | 📅 2026-09-03 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,304 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-02 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
...
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,229 | 🐛 59 | 🌐 Go | 📅 2026-09-03 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,761 | 🐛 68 | 🌐 Go | 📅 2026-09-03-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,901 | 🐛 103 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,760 | 🐛 723 | 🌐 C++ | 📅 2026-09-02 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,229 | 🐛 159 | 🌐 Python | 📅 2026-09-03
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 467 | 🐛 324 | 🌐 TypeScript | 📅 2026-09-02.
