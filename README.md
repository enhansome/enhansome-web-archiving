...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,277 | 🐛 159 | 🌐 Python | 📅 2026-09-11 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,371 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-11 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,474 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
* [DiskerNet](https://github.com/DO-SAY-GO/dn) ⭐ 3,908 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - A non-WARC-based tool which hooks into the Chrome browser and archives everything you browse making it available for offline replay. *(In Development)*
...
* [grab-site](https://github.com/ArchiveTeam/grab-site) ⭐ 1,612 | 🐛 103 | 🌐 Python | 📅 2025-05-23 - The archivist's web crawler: WARC output, dashboard for all crawls, dynamic ignore patterns. *(Stable)*
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,132 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-11 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [Waybackpy](https://github.com/akamhy/waybackpy) ⭐ 604 | 🐛 23 | 🌐 Python | 📅 2024-02-26 -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool  *(Stable)*
...
* [crau](https://github.com/turicas/crau) ⭐ 65 | 🐛 11 | 🌐 Python | 📅 2026-04-13 - A lightweight command-line tool for archiving the Web and playing archives: you just need a list of URLs. The name "crau" stems from the Brazilian pronounciation of "crawl". *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 51 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-05 - A npm package and CLI tool for saving webpages. *(Stable)*
...
* [hyphe](https://github.com/medialab/hyphe) ⭐ 387 | 🐛 56 | 🌐 JavaScript | 📅 2026-05-18 - A webcrawler built for research uses with a graphical user interface in order to build web corpuses made of lists of web actors and maps of links between them. *(Stable)*
...
* [playback](https://github.com/wabarc/playback) ⭐ 13 | 🐛 6 | 🌐 Go | 📅 2026-08-22 - A toolkit for searching archived webpages from <!--lint ignore double-link-->[Internet Archive](https://web.archive.org), [archive.today](https://archive.today), [Memento](http://timetravel.mementoweb.org) and beyond. *(In Development)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,761 | 🐛 68 | 🌐 Go | 📅 2026-09-08-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 147 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,834 | 🐛 721 | 🌐 C++ | 📅 2026-09-11 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,277 | 🐛 159 | 🌐 Python | 📅 2026-09-11
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 472 | 🐛 322 | 🌐 TypeScript | 📅 2026-09-11.
