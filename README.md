...
# Awesome Web Archiving with stars
...
* [A Whirlwind Tour of Common Crawl's Datasets using Python](https://github.com/commoncrawl/whirlwind-python/) ⭐ 46 | 🐛 0 | 🌐 Python | 📅 2026-06-15
* [UNT Web Archiving Course](https://github.com/vphill/web-archiving-course) ⭐ 24 | 🐛 10 | 📅 2024-03-04
* [A Whirlwind Tour of Common Crawl's Datasets as a Python notebook](https://github.com/commoncrawl/whirlwind-python-notebook) ⭐ 4 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-12-31
* [A Whirlwind Tour of Common Crawl's Datasets using Java](https://github.com/commoncrawl/whirlwind-java/) ⭐ 3 | 🐛 1 | 🌐 Java | 📅 2026-04-20
...
* [Awesome Website Change Monitoring](https://github.com/edgi-govdata-archiving/awesome-website-change-monitoring) ⭐ 514 | 🐛 8 | 📅 2026-08-11
* [Comparison of web archiving software](https://github.com/archivers-space/research/tree/master/web_archiving) ⭐ 100 | 🐛 8 | 📅 2018-09-27

### Acquisition

* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,335 | 🐛 159 | 🌐 Python | 📅 2026-09-11 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,377 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-13 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,475 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
* [DiskerNet](https://github.com/DO-SAY-GO/dn) ⭐ 3,909 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - A non-WARC-based tool which hooks into the Chrome browser and archives everything you browse making it available for offline replay. *(In Development)*
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,319 | 🐛 38 | 🌐 Java | 📅 2026-09-10 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,319 | 🐛 38 | 🌐 Java | 📅 2026-09-10 - A discussion forum for asking questions and getting answers about using Heritrix.
  * [Heritrix Walkthrough](https://github.com/web-archive-group/heritrix-walkthrough) ⭐ 10 | 🐛 2 | 🌐 Shell | 📅 2016-06-10 *(In Development)*
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,231 | 🐛 63 | 🌐 Go | 📅 2026-09-07 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
* [grab-site](https://github.com/ArchiveTeam/grab-site) ⭐ 1,611 | 🐛 103 | 🌐 Python | 📅 2025-05-23 - The archivist's web crawler: WARC output, dashboard for all crawls, dynamic ignore patterns. *(Stable)*
* [twarc](https://github.com/DocNow/twarc) ⭐ 1,393 | 🐛 47 | 🌐 Python | 📅 2025-10-31 - A command line tool and Python library for archiving Twitter JSON data. *(Stable)*
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,134 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-11 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
* [Auto Archiver](https://github.com/bellingcat/auto-archiver) ⭐ 1,114 | 🐛 12 | 🌐 Python | 📅 2026-09-10 - Python script to automatically archive social media posts, videos, and images from a Google Sheets document. Read the [article about Auto Archiver on bellingcat.com](https://www.bellingcat.com/resources/2022/09/22/preserve-vital-online-content-with-bellingcats-auto-archiver-tool/).
* [Brozzler](https://github.com/internetarchive/brozzler) ⭐ 820 | 🐛 64 | 🌐 Python | 📅 2026-08-20 - A distributed web crawler (爬虫) that uses a real browser (Chrome or Chromium) to fetch pages and embedded urls and to extract links. *(Stable)*
* [Wpull](https://github.com/ArchiveTeam/wpull) ⭐ 614 | 🐛 206 | 🌐 HTML | 📅 2024-04-29 - A Wget-compatible (or remake/clone/replacement/alternative) web downloader and crawler. *(Stable)*
* [Waybackpy](https://github.com/akamhy/waybackpy) ⭐ 604 | 🐛 22 | 🌐 Python | 📅 2024-02-26 -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool  *(Stable)*
* [Warcprox](https://github.com/internetarchive/warcprox) ⭐ 466 | 🐛 31 | 🌐 Python | 📅 2026-06-17 - WARC-writing MITM HTTP/S proxy. *(Stable)*
* [archivenow](https://github.com/oduwsdl/archivenow) ⭐ 434 | 🐛 17 | 🌐 Python | 📅 2024-01-23 - A [Python library](http://ws-dl.blogspot.com/2017/02/2017-02-22-archive-now-archivenow.html) to push web resources into on-demand web archives. *(Stable)*
* [WAIL](https://github.com/machawk1/wail) ⭐ 401 | 🐛 184 | 🌐 Roff | 📅 2026-06-19 - A graphical user interface (GUI) atop multiple web archiving tools intended to be used as an easy way for anyone to preserve and replay web pages; [Python](https://machawk1.github.io/wail/), [Electron](https://github.com/n0tan3rd/wail) ⭐ 128 | 🐛 34 | 🌐 JavaScript | 📅 2019-02-03. *(Stable)*
* [Obelisk](https://github.com/go-shiori/obelisk) ⭐ 320 | 🐛 10 | 🌐 Go | 📅 2026-02-01 - Go package and CLI tool for saving web page as single HTML file. *(Stable)*
* [freeze-dry](https://github.com/WebMemex/freeze-dry) ⭐ 306 | 🐛 22 | 🌐 TypeScript | 📅 2022-09-18 - JavaScript library to turn page into static, self-contained HTML document; useful for browser extensions. *(In Development)*
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 212 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-11 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
* [Squidwarc](https://github.com/N0taN3rd/Squidwarc) ⭐ 178 | 🐛 11 | 🌐 JavaScript | 📅 2020-05-19 - An [open source, high-fidelity, page interacting](http://ws-dl.blogspot.com/2017/07/2017-07-24-replacing-heritrix-with.html) archival crawler that uses Chrome or Chrome Headless directly. *(In Development)*
...
* [crau](https://github.com/turicas/crau) ⭐ 65 | 🐛 11 | 🌐 Python | 📅 2026-09-12 - A lightweight command-line tool for archiving the Web and playing archives: you just need a list of URLs. The name "crau" stems from the Brazilian pronounciation of "crawl". *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 51 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-12 - A npm package and CLI tool for saving webpages. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,701 | 🐛 182 | 🌐 JavaScript | 📅 2026-09-11 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
* [InterPlanetary Wayback (ipwb)](https://github.com/oduwsdl/ipwb) ⭐ 656 | 🐛 160 | 🌐 Python | 📅 2026-07-24 - Web Archive (WARC) indexing and replay using [IPFS](https://ipfs.io/).
* [OpenWayback](https://github.com/iipc/openwayback/) ⭐ 528 | 🐛 105 | 🌐 Java | 📅 2024-01-03 - The open source project aimed to develop Wayback Machine, the key software used by web archives worldwide to play back archived websites in the user's browser. *(Stable)*
...
* [hyphe](https://github.com/medialab/hyphe) ⭐ 388 | 🐛 56 | 🌐 JavaScript | 📅 2026-05-18 - A webcrawler built for research uses with a graphical user interface in order to build web corpuses made of lists of web actors and maps of links between them. *(Stable)*
* [SolrWayback](https://github.com/netarchivesuite/solrwayback) ⭐ 147 | 🐛 65 | 🌐 Java | 📅 2026-09-08 - A backend Java and frontend VUE JS project with freetext search and a build in playback engine. Require Warc files has been index with the Warc-Indexer. The web application also has a wide range of data visualization tools and data export tools that can be used on the whole webarchive. [SolrWayback 4 Bundle release](https://github.com/netarchivesuite/solrwayback/releases) ⭐ 147 | 🐛 65 | 🌐 Java | 📅 2026-09-08 contains all the software and dependencies in an out-of-the box solution that is easy to install.
* [webarchive-discovery](https://github.com/ukwa/webarchive-discovery) ⭐ 133 | 🐛 93 | 🌐 Java | 📅 2025-11-21 - WARC and ARC full-text indexing and discovery tools, with a number of associated tools capable of using the index shown below. *(Stable)*
* Other possible options for builting a front-end are listed on in the `webarchive-discovery` wiki, [here](https://github.com/ukwa/webarchive-discovery/wiki/Front-ends) ⭐ 133 | 🐛 93 | 🌐 Java | 📅 2025-11-21.
* [Mink](https://github.com/machawk1/Mink) ⭐ 59 | 🐛 95 | 🌐 JavaScript | 📅 2025-08-27 - A [Google Chrome](https://www.google.com/intl/en/chrome/) extension for querying Memento aggregators while browsing and integrating live-archived web navigation. *(Stable)*
...
* [playback](https://github.com/wabarc/playback) ⭐ 13 | 🐛 5 | 🌐 Go | 📅 2026-08-22 - A toolkit for searching archived webpages from <!--lint ignore double-link-->[Internet Archive](https://web.archive.org), [archive.today](https://archive.today), [Memento](http://timetravel.mementoweb.org) and beyond. *(In Development)*
* [PastPage](https://github.com/nabertronic/pastpage) ⭐ 7 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-10 - Browser extension for Chrome and Firefox that recovers broken or changed pages by querying the Wayback Machine and other web archives in parallel. *(Stable)*
...
* [Go Get Crawl](https://github.com/karust/gogetcrawl) ⭐ 184 | 🐛 0 | 🌐 Go | 📅 2024-11-04 - Extract web archive data using <!--lint ignore double-link-->[Wayback Machine](https://web.archive.org/) and [Common Crawl](https://commoncrawl.org/). *(Stable)*
* [ArchiveTools](https://github.com/recrm/ArchiveTools) ⭐ 81 | 🐛 2 | 🌐 Python | 📅 2022-07-06 - Collection of tools to extract and interact with WARC files (Python).
...
* [duckdb-web-archive-cdx](https://github.com/midwork-finds-jobs/duckdb-web-archive) ⭐ 23 | 🐛 2 | 🌐 C++ | 📅 2026-06-27 - DuckDB extension to query the Internet Archive and CommonCrawl CDX APIs directly from SQL. *(In Development)*
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,761 | 🐛 69 | 🌐 Go | 📅 2026-09-08-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
* [duckdb\_warc](https://github.com/midwork-finds-jobs/duckdb_warc) ⭐ 7 | 🐛 2 | 🌐 Rust | 📅 2026-02-05 - DuckDB extension to query WARC files. *(In Development)*
* [bagnabit2warc](https://github.com/internetarchive/bagnabit2warc) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-03-09 - Convert a [bag-nabit](https://github.com/harvard-lil/bag-nabit) ⭐ 40 | 🐛 1 | 🌐 Python | 📅 2025-03-31 dataset stored in a ZIP into a full-content WARC.
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,904 | 🐛 105 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 866 | 🐛 171 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [MemGator](https://github.com/oduwsdl/MemGator) ⭐ 80 | 🐛 49 | 🌐 Go | 📅 2026-04-09 - A Memento Aggregator CLI and Server (Golang). *(Stable)*
...
* [OutbackCDX](https://github.com/nla/outbackcdx) ⭐ 45 | 🐛 23 | 🌐 Java | 📅 2026-09-01 - RocksDB-based capture index (CDX) server supporting incremental updates and compression. Can be used as backend for OpenWayback, PyWb and [Heritrix](https://github.com/ukwa/ukwa-heritrix/blob/master/src/main/java/uk/bl/wap/modules/uriuniqfilters/OutbackCDXRecentlySeenUriUniqFilter.java) ⚠️ Archived. *(Stable)*
* [httrack2warc](https://github.com/nla/httrack2warc) ⭐ 37 | 🐛 2 | 🌐 Java | 📅 2024-08-06 - Convert HTTrack archives to WARC format (Java).
* [warcbench](https://github.com/harvard-lil/warcbench) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2025-07-30 - A tool for exploring, analyzing, transforming, recombining, and extracting data from WARC (Web ARChive) files.
* [warc-safe](https://github.com/natliblux/warc-safe) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - Automatic detection of viruses and NSFW content in WARC files.
...
* [MementoMap](https://github.com/oduwsdl/MementoMap) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2021-06-15 - A Tool to Summarize Web Archive Holdings (Python). *(In Development)*
...
* [HTTPreserve linkstat](https://github.com/httpreserve/linkstat) ⭐ 10 | 🐛 2 | 🌐 Go | 📅 2026-07-05 - Command line implementation of <!--lint ignore double-link-->[httpreserve.info](https://httpreserve.info) to describe the status of a web page. Can be easily scripted and provides JSON output to enable querying through tools like JQ. HTTPreserve Linkstat describes current status, and earliest and latest links on <!--lint ignore double-link-->[archive.org](https://archive.org/). (Golang). *(Stable)*
* [warcrefs](https://github.com/arcalex/warcrefs) ⭐ 10 | 🐛 11 | 🌐 Java | 📅 2018-10-18 - Web archive deduplication tools. *(Stable)*
* [wasapi-downloader](https://github.com/sul-dlss/wasapi-downloader) ⚠️ Archived - Java command line application to download crawls from WASAPI. *(Stable)*
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 472 | 🐛 63 | 🌐 Python | 📅 2026-06-10 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
* [warctools](https://github.com/internetarchive/warctools) ⭐ 178 | 🐛 17 | 🌐 Python | 📅 2025-08-18 - Library to work with ARC and WARC files (Python).
* [Warcat](https://github.com/chfoo/warcat) ⭐ 166 | 🐛 15 | 🌐 Python | 📅 2024-10-11 - Tool and library for handling Web ARChive (WARC) files (Python). *(Stable)*
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 148 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
* [node-warc](https://github.com/N0taN3rd/node-warc) ⭐ 105 | 🐛 23 | 🌐 JavaScript | 📅 2025-01-29 - Parse WARC files or create WARC files using either [Electron](https://electron.atom.io/) or [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,553 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 (Node.js). *(Stable)*
* [jwarc](https://github.com/iipc/jwarc) ⭐ 62 | 🐛 19 | 🌐 Java | 📅 2026-09-01 - Read and write WARC files with a type safe API (Java).
* [warc](https://github.com/jedireza/warc) ⭐ 61 | 🐛 10 | 🌐 Rust | 📅 2024-11-27 - A Rust library for reading and writing WARC files. *(Stable)*
* [Warcat-rs](https://github.com/chfoo/warcat-rs) ⭐ 34 | 🐛 5 | 🌐 Rust | 📅 2025-06-02 - Command-line tool and Rust library for handling Web ARChive (WARC) files. *(In Development)*
...
* [Sparkling](https://github.com/internetarchive/Sparkling) ⭐ 17 | 🐛 1 | 🌐 Scala | 📅 2026-05-04 - Internet Archive's Sparkling Data Processing Library. *(Stable)*
* [Unwarcit](https://github.com/emmadickson/unwarcit) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2022-01-07 - Command line interface to unzip WARC and WACZ files (Python).
...
* [ArchiveSpark](https://github.com/helgeho/ArchiveSpark) ⭐ 162 | 🐛 5 | 🌐 Scala | 📅 2025-10-08 - An Apache Spark framework (not only) for Web Archives that enables easy data processing, extraction as well as derivation. *(Stable)*
* [Archives Unleashed Toolkit](https://github.com/archivesunleashed/aut) ⭐ 158 | 🐛 5 | 🌐 Scala | 📅 2025-12-05 - An open-source platform for analyzing web archives with Apache Spark. *(Stable)*
* [Common Crawl Jupyter notebooks](https://github.com/commoncrawl/cc-notebooks) ⭐ 69 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-08 - A collection of notebooks using Common Crawl's various datasets. *(Stable)*
...
* [Archives Research Compute Hub](https://github.com/internetarchive/arch) ⭐ 21 | 🐛 0 | 🌐 Scala | 📅 2026-03-24 - Web application for distributed compute analysis of Archive-It web archive collections. *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,838 | 🐛 720 | 🌐 C++ | 📅 2026-09-12 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,847 | 🐛 324 | 🌐 C | 📅 2026-06-30 - Click automation on Ubuntu.
...
* [Zotero Robust Links Extension](https://robustlinks.mementoweb.org/zotero/) - A [Zotero](https://www.zotero.org/) extension that submits to and reads from web archives. Source [on GitHub](https://github.com/lanl/Zotero-Robust-Links-Extension) ⭐ 22 | 🐛 3 | 🌐 JavaScript | 📅 2022-05-10. Supercedes [leonkt/zotero-memento](https://github.com/leonkt/zotero-memento) ⭐ 358 | 🐛 12 | 🌐 JavaScript | 📅 2022-06-08.

## Community Resources

### Other Awesome Lists

* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,335 | 🐛 159 | 🌐 Python | 📅 2026-09-11
* [Awesome Memento](https://github.com/machawk1/awesome-memento) ⭐ 122 | 🐛 3 | 📅 2026-05-22
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 474 | 🐛 322 | 🌐 TypeScript | 📅 2026-09-11.
...
* [Dead-Web Index](https://github.com/Crawlora-org/dead-web-index-data) ⭐ 2 | 🐛 0 | 📅 2026-07-28 - Reachability labels (alive / blocked / dead) for the top 10 million domains, two probe arms (polite HTTP and a browser TLS fingerprint), 2026. CC BY 4.0, JSONL.
