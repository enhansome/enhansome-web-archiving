...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,580 | 🐛 161 | 🌐 Python | 📅 2026-09-24 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,472 | 🐛 100 | 🌐 JavaScript | 📅 2026-09-24 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,496 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,321 | 🐛 36 | 🌐 Java | 📅 2026-09-22 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,321 | 🐛 36 | 🌐 Java | 📅 2026-09-22 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,146 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-22 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [WAIL](https://github.com/machawk1/wail) ⭐ 401 | 🐛 185 | 🌐 Roff | 📅 2026-06-19 - A graphical user interface (GUI) atop multiple web archiving tools intended to be used as an easy way for anyone to preserve and replay web pages; [Python](https://machawk1.github.io/wail/), [Electron](https://github.com/n0tan3rd/wail) ⭐ 128 | 🐛 34 | 🌐 JavaScript | 📅 2019-02-03. *(Stable)*
* [Obelisk](https://github.com/go-shiori/obelisk) ⭐ 322 | 🐛 10 | 🌐 Go | 📅 2026-02-01 - Go package and CLI tool for saving web page as single HTML file. *(Stable)*
...
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 213 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-23 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,701 | 🐛 192 | 🌐 JavaScript | 📅 2026-09-22 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,768 | 🐛 68 | 🌐 Go | 📅 2026-09-23-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,911 | 🐛 108 | 🌐 Python | 📅 2026-09-15 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 871 | 🐛 171 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 150 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,922 | 🐛 731 | 🌐 C++ | 📅 2026-09-17 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,846 | 🐛 324 | 🌐 C | 📅 2026-09-20 - Click automation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,580 | 🐛 161 | 🌐 Python | 📅 2026-09-24
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 476 | 🐛 330 | 🌐 TypeScript | 📅 2026-09-24.
