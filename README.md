...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,420 | 🐛 159 | 🌐 Python | 📅 2026-09-14 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,390 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-14 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,480 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,319 | 🐛 38 | 🌐 Java | 📅 2026-09-14 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,319 | 🐛 38 | 🌐 Java | 📅 2026-09-14 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,135 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-11 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [Obelisk](https://github.com/go-shiori/obelisk) ⭐ 321 | 🐛 10 | 🌐 Go | 📅 2026-02-01 - Go package and CLI tool for saving web page as single HTML file. *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 52 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-12 - A npm package and CLI tool for saving webpages. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,763 | 🐛 69 | 🌐 Go | 📅 2026-09-08-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,905 | 🐛 105 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 867 | 🐛 171 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [warcbench](https://github.com/harvard-lil/warcbench) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2025-07-30 - A tool for exploring, analyzing, transforming, recombining, and extracting data from WARC (Web ARChive) files.
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 149 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,842 | 🐛 721 | 🌐 C++ | 📅 2026-09-12 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,420 | 🐛 159 | 🌐 Python | 📅 2026-09-14
