...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,121 | 🐛 170 | 🌐 Python | 📅 2026-08-16 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,155 | 🐛 160 | 🌐 JavaScript | 📅 2026-08-05 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,423 | 🐛 72 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,297 | 🐛 36 | 🌐 Java | 📅 2026-08-05 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,297 | 🐛 36 | 🌐 Java | 📅 2026-08-05 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,108 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-14 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [Waybackpy](https://github.com/akamhy/waybackpy) ⭐ 602 | 🐛 22 | 🌐 Python | 📅 2024-02-26 -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool  *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,687 | 🐛 182 | 🌐 JavaScript | 📅 2026-04-10 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 18 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,751 | 🐛 69 | 🌐 Go | 📅 2026-08-13-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,626 | 🐛 697 | 🌐 C++ | 📅 2026-08-12 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,121 | 🐛 170 | 🌐 Python | 📅 2026-08-16
