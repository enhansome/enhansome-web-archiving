...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,246 | 🐛 160 | 🌐 Python | 📅 2026-09-04 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,338 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-07 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,469 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,317 | 🐛 37 | 🌐 Java | 📅 2026-09-02 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,317 | 🐛 37 | 🌐 Java | 📅 2026-09-02 - A discussion forum for asking questions and getting answers about using Heritrix.
  * [Heritrix Walkthrough](https://github.com/web-archive-group/heritrix-walkthrough) ⭐ 10 | 🐛 2 | 🌐 Shell | 📅 2016-06-10 *(In Development)*
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,230 | 🐛 62 | 🌐 Go | 📅 2026-09-04 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
* [grab-site](https://github.com/ArchiveTeam/grab-site) ⭐ 1,611 | 🐛 104 | 🌐 Python | 📅 2025-05-23 - The archivist's web crawler: WARC output, dashboard for all crawls, dynamic ignore patterns. *(Stable)*
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,128 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-06 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,699 | 🐛 183 | 🌐 JavaScript | 📅 2026-08-26 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,758 | 🐛 68 | 🌐 Go | 📅 2026-09-05-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,904 | 🐛 103 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
...
* [warcbench](https://github.com/harvard-lil/warcbench) ⭐ 24 | 🐛 3 | 🌐 Python | 📅 2025-07-30 - A tool for exploring, analyzing, transforming, recombining, and extracting data from WARC (Web ARChive) files.
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 471 | 🐛 63 | 🌐 Python | 📅 2026-06-10 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
...
* [node-warc](https://github.com/N0taN3rd/node-warc) ⭐ 105 | 🐛 23 | 🌐 JavaScript | 📅 2025-01-29 - Parse WARC files or create WARC files using either [Electron](https://electron.atom.io/) or [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,554 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 (Node.js). *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,791 | 🐛 725 | 🌐 C++ | 📅 2026-09-06 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,246 | 🐛 160 | 🌐 Python | 📅 2026-09-04
