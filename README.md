...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,592 | 🐛 162 | 🌐 Python | 📅 2026-09-25 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,481 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-24 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
...
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,233 | 🐛 64 | 🌐 Go | 📅 2026-09-07 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
...
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 213 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-25 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,771 | 🐛 68 | 🌐 Go | 📅 2026-09-23-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [MemGator](https://github.com/oduwsdl/MemGator) ⭐ 81 | 🐛 50 | 🌐 Go | 📅 2026-04-09 - A Memento Aggregator CLI and Server (Golang). *(Stable)*
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,592 | 🐛 162 | 🌐 Python | 📅 2026-09-25
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 476 | 🐛 330 | 🌐 TypeScript | 📅 2026-09-25.
