...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,541 | 🐛 160 | 🌐 Python | 📅 2026-09-20 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,436 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-20 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,320 | 🐛 40 | 🌐 Java | 📅 2026-09-17 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,320 | 🐛 40 | 🌐 Java | 📅 2026-09-17 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 52 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-19 - A npm package and CLI tool for saving webpages as single HTML files. It does not produce WARC or WACZ archives. *(Stable)*
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 474 | 🐛 63 | 🌐 Python | 📅 2026-06-10 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,893 | 🐛 724 | 🌐 C++ | 📅 2026-09-17 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,844 | 🐛 325 | 🌐 C | 📅 2026-06-30 - Click automation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,541 | 🐛 160 | 🌐 Python | 📅 2026-09-20
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 476 | 🐛 328 | 🌐 TypeScript | 📅 2026-09-18.
