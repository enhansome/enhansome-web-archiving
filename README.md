...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,268 | 🐛 159 | 🌐 Python | 📅 2026-09-07 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,366 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-09 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,471 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,318 | 🐛 38 | 🌐 Java | 📅 2026-09-10 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,318 | 🐛 38 | 🌐 Java | 📅 2026-09-10 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,132 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-11 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [Wpull](https://github.com/ArchiveTeam/wpull) ⭐ 613 | 🐛 206 | 🌐 HTML | 📅 2024-04-29 - A Wget-compatible (or remake/clone/replacement/alternative) web downloader and crawler. *(Stable)*
...
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 211 | 🐛 16 | 🌐 JavaScript | 📅 2025-09-03 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,760 | 🐛 68 | 🌐 Go | 📅 2026-09-08-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,829 | 🐛 719 | 🌐 C++ | 📅 2026-09-11 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,846 | 🐛 324 | 🌐 C | 📅 2026-06-30 - Click automation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,268 | 🐛 159 | 🌐 Python | 📅 2026-09-07
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 472 | 🐛 323 | 🌐 TypeScript | 📅 2026-09-11.
