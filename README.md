...
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,226 | 🐛 163 | 🌐 JavaScript | 📅 2026-08-05 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,691 | 🐛 182 | 🌐 JavaScript | 📅 2026-04-10 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,757 | 🐛 70 | 🌐 Go | 📅 2026-08-22-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,678 | 🐛 713 | 🌐 C++ | 📅 2026-08-22 - Screen capture and annotation on Ubuntu.
