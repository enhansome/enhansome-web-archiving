...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,198 | 🐛 159 | 🌐 Python | 📅 2026-08-29 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,263 | 🐛 103 | 🌐 JavaScript | 📅 2026-08-29 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,456 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,309 | 🐛 37 | 🌐 Java | 📅 2026-08-25 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,309 | 🐛 37 | 🌐 Java | 📅 2026-08-25 - A discussion forum for asking questions and getting answers about using Heritrix.
  * [Heritrix Walkthrough](https://github.com/web-archive-group/heritrix-walkthrough) ⭐ 10 | 🐛 2 | 🌐 Shell | 📅 2016-06-10 *(In Development)*
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,228 | 🐛 59 | 🌐 Go | 📅 2026-08-28 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,122 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-27 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [Warcprox](https://github.com/internetarchive/warcprox) ⭐ 464 | 🐛 32 | 🌐 Python | 📅 2026-06-17 - WARC-writing MITM HTTP/S proxy. *(Stable)*
...
* [freeze-dry](https://github.com/WebMemex/freeze-dry) ⭐ 306 | 🐛 21 | 🌐 TypeScript | 📅 2022-09-18 - JavaScript library to turn page into static, self-contained HTML document; useful for browser extensions. *(In Development)*
...
* [SolrWayback](https://github.com/netarchivesuite/solrwayback) ⭐ 147 | 🐛 65 | 🌐 Java | 📅 2026-08-26 - A backend Java and frontend VUE JS project with freetext search and a build in playback engine. Require Warc files has been index with the Warc-Indexer. The web application also has a wide range of data visualization tools and data export tools that can be used on the whole webarchive. [SolrWayback 4 Bundle release](https://github.com/netarchivesuite/solrwayback/releases) ⭐ 147 | 🐛 65 | 🌐 Java | 📅 2026-08-26 contains all the software and dependencies in an out-of-the box solution that is easy to install.
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,762 | 🐛 67 | 🌐 Go | 📅 2026-08-28-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,897 | 🐛 103 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 862 | 🐛 171 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [OutbackCDX](https://github.com/nla/outbackcdx) ⭐ 44 | 🐛 22 | 🌐 Java | 📅 2026-08-01 - RocksDB-based capture index (CDX) server supporting incremental updates and compression. Can be used as backend for OpenWayback, PyWb and [Heritrix](https://github.com/ukwa/ukwa-heritrix/blob/master/src/main/java/uk/bl/wap/modules/uriuniqfilters/OutbackCDXRecentlySeenUriUniqFilter.java) ⚠️ Archived. *(Stable)*
* [httrack2warc](https://github.com/nla/httrack2warc) ⭐ 36 | 🐛 2 | 🌐 Java | 📅 2024-08-06 - Convert HTTrack archives to WARC format (Java).
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 470 | 🐛 64 | 🌐 Python | 📅 2026-06-10 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 145 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,709 | 🐛 716 | 🌐 C++ | 📅 2026-08-28 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,198 | 🐛 159 | 🌐 Python | 📅 2026-08-29
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 464 | 🐛 318 | 🌐 TypeScript | 📅 2026-08-29.
