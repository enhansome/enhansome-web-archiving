...
* [Awesome Website Change Monitoring](https://github.com/edgi-govdata-archiving/awesome-website-change-monitoring) ⭐ 514 | 🐛 9 | 📅 2026-08-11
...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,234 | 🐛 159 | 🌐 Python | 📅 2026-09-04 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,316 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-04 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,464 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
* [DiskerNet](https://github.com/DO-SAY-GO/dn) ⭐ 3,907 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-03 - A non-WARC-based tool which hooks into the Chrome browser and archives everything you browse making it available for offline replay. *(In Development)*
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,315 | 🐛 37 | 🌐 Java | 📅 2026-09-02 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,315 | 🐛 37 | 🌐 Java | 📅 2026-09-02 - A discussion forum for asking questions and getting answers about using Heritrix.
  * [Heritrix Walkthrough](https://github.com/web-archive-group/heritrix-walkthrough) ⭐ 10 | 🐛 2 | 🌐 Shell | 📅 2016-06-10 *(In Development)*
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,229 | 🐛 62 | 🌐 Go | 📅 2026-09-04 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
* [grab-site](https://github.com/ArchiveTeam/grab-site) ⭐ 1,609 | 🐛 104 | 🌐 Python | 📅 2025-05-23 - The archivist's web crawler: WARC output, dashboard for all crawls, dynamic ignore patterns. *(Stable)*
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,127 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-27 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
* [Auto Archiver](https://github.com/bellingcat/auto-archiver) ⭐ 1,112 | 🐛 11 | 🌐 Python | 📅 2026-09-01 - Python script to automatically archive social media posts, videos, and images from a Google Sheets document. Read the [article about Auto Archiver on bellingcat.com](https://www.bellingcat.com/resources/2022/09/22/preserve-vital-online-content-with-bellingcats-auto-archiver-tool/).
* [Brozzler](https://github.com/internetarchive/brozzler) ⭐ 818 | 🐛 64 | 🌐 Python | 📅 2026-08-20 - A distributed web crawler (爬虫) that uses a real browser (Chrome or Chromium) to fetch pages and embedded urls and to extract links. *(Stable)*
* [Wpull](https://github.com/ArchiveTeam/wpull) ⭐ 613 | 🐛 205 | 🌐 HTML | 📅 2024-04-29 - A Wget-compatible (or remake/clone/replacement/alternative) web downloader and crawler. *(Stable)*
...
* [Warcprox](https://github.com/internetarchive/warcprox) ⭐ 464 | 🐛 31 | 🌐 Python | 📅 2026-06-17 - WARC-writing MITM HTTP/S proxy. *(Stable)*
...
* [freeze-dry](https://github.com/WebMemex/freeze-dry) ⭐ 307 | 🐛 21 | 🌐 TypeScript | 📅 2022-09-18 - JavaScript library to turn page into static, self-contained HTML document; useful for browser extensions. *(In Development)*
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 210 | 🐛 16 | 🌐 JavaScript | 📅 2025-09-03 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
...
* [crau](https://github.com/turicas/crau) ⭐ 64 | 🐛 11 | 🌐 Python | 📅 2026-04-13 - A lightweight command-line tool for archiving the Web and playing archives: you just need a list of URLs. The name "crau" stems from the Brazilian pronounciation of "crawl". *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 51 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-03 - A npm package and CLI tool for saving webpages. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,698 | 🐛 183 | 🌐 JavaScript | 📅 2026-08-26 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [OpenWayback](https://github.com/iipc/openwayback/) ⭐ 527 | 🐛 105 | 🌐 Java | 📅 2024-01-03 - The open source project aimed to develop Wayback Machine, the key software used by web archives worldwide to play back archived websites in the user's browser. *(Stable)*
...
* [SolrWayback](https://github.com/netarchivesuite/solrwayback) ⭐ 147 | 🐛 62 | 🌐 Java | 📅 2026-09-04 - A backend Java and frontend VUE JS project with freetext search and a build in playback engine. Require Warc files has been index with the Warc-Indexer. The web application also has a wide range of data visualization tools and data export tools that can be used on the whole webarchive. [SolrWayback 4 Bundle release](https://github.com/netarchivesuite/solrwayback/releases) ⭐ 147 | 🐛 62 | 🌐 Java | 📅 2026-09-04 contains all the software and dependencies in an out-of-the box solution that is easy to install.
...
* [Go Get Crawl](https://github.com/karust/gogetcrawl) ⭐ 183 | 🐛 0 | 🌐 Go | 📅 2024-11-04 - Extract web archive data using <!--lint ignore double-link-->[Wayback Machine](https://web.archive.org/) and [Common Crawl](https://commoncrawl.org/). *(Stable)*
...
* [duckdb-web-archive-cdx](https://github.com/midwork-finds-jobs/duckdb-web-archive) ⭐ 22 | 🐛 2 | 🌐 C++ | 📅 2026-06-27 - DuckDB extension to query the Internet Archive and CommonCrawl CDX APIs directly from SQL. *(In Development)*
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,759 | 🐛 68 | 🌐 Go | 📅 2026-09-03-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,902 | 🐛 103 | 🌐 Python | 📅 2026-08-25 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 864 | 🐛 171 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [warcbench](https://github.com/harvard-lil/warcbench) ⭐ 23 | 🐛 3 | 🌐 Python | 📅 2025-07-30 - A tool for exploring, analyzing, transforming, recombining, and extracting data from WARC (Web ARChive) files.
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 471 | 🐛 64 | 🌐 Python | 📅 2026-06-10 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
* [warctools](https://github.com/internetarchive/warctools) ⭐ 177 | 🐛 17 | 🌐 Python | 📅 2025-08-18 - Library to work with ARC and WARC files (Python).
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 146 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A high-performance WARC parsing library (Python).
* [node-warc](https://github.com/N0taN3rd/node-warc) ⭐ 105 | 🐛 23 | 🌐 JavaScript | 📅 2025-01-29 - Parse WARC files or create WARC files using either [Electron](https://electron.atom.io/) or [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,552 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 (Node.js). *(Stable)*
* [jwarc](https://github.com/iipc/jwarc) ⭐ 61 | 🐛 19 | 🌐 Java | 📅 2026-09-01 - Read and write WARC files with a type safe API (Java).
...
* [Common Crawl Jupyter notebooks](https://github.com/commoncrawl/cc-notebooks) ⭐ 68 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-08-18 - A collection of notebooks using Common Crawl's various datasets. *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,776 | 🐛 726 | 🌐 C++ | 📅 2026-09-02 - Screen capture and annotation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,234 | 🐛 159 | 🌐 Python | 📅 2026-09-04
* [Awesome Memento](https://github.com/machawk1/awesome-memento) ⭐ 121 | 🐛 3 | 📅 2026-05-22
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 468 | 🐛 322 | 🌐 TypeScript | 📅 2026-09-04.
