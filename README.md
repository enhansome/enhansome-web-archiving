...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,439 | 🐛 159 | 🌐 Python | 📅 2026-09-14 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,400 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-15 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,484 | 🐛 73 | 🌐 Rust | 📅 2026-05-25 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,319 | 🐛 41 | 🌐 Java | 📅 2026-09-15 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,319 | 🐛 41 | 🌐 Java | 📅 2026-09-15 - A discussion forum for asking questions and getting answers about using Heritrix.
...
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,136 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-11 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
...
* [SolrWayback](https://github.com/netarchivesuite/solrwayback) ⭐ 147 | 🐛 66 | 🌐 Java | 📅 2026-09-14 - A backend Java and frontend VUE JS project with freetext search and a build in playback engine. Require Warc files has been index with the Warc-Indexer. The web application also has a wide range of data visualization tools and data export tools that can be used on the whole webarchive. [SolrWayback 4 Bundle release](https://github.com/netarchivesuite/solrwayback/releases) ⭐ 147 | 🐛 66 | 🌐 Java | 📅 2026-09-14 contains all the software and dependencies in an out-of-the box solution that is easy to install.
...
* [Go Get Crawl](https://github.com/karust/gogetcrawl) ⭐ 185 | 🐛 0 | 🌐 Go | 📅 2024-11-04 - Extract web archive data using <!--lint ignore double-link-->[Wayback Machine](https://web.archive.org/) and [Common Crawl](https://commoncrawl.org/). *(Stable)*
...
* [bagnabit2warc](https://github.com/internetarchive/bagnabit2warc) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-03-09 - Convert a [bag-nabit](https://github.com/harvard-lil/bag-nabit) ⭐ 40 | 🐛 2 | 🌐 Python | 📅 2026-09-14 dataset stored in a ZIP into a full-content WARC.
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 30,853 | 🐛 721 | 🌐 C++ | 📅 2026-09-12 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,847 | 🐛 325 | 🌐 C | 📅 2026-06-30 - Click automation on Ubuntu.
...
* [Web Archiving Community](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community) ⭐ 28,439 | 🐛 159 | 🌐 Python | 📅 2026-09-14
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 474 | 🐛 322 | 🌐 TypeScript | 📅 2026-09-15.
